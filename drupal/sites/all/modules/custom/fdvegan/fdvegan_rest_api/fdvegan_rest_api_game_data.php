<?php
/**
 * fdvegan_rest_api_game_data.php
 *
 * Implementation of all "Model" game data for sub-module fdvegan_rest_api.
 *
 * PHP version 5.6
 *
 * @category   Content
...
/*
    The game_data object returned is in the following format:
    ...
    A hint can be any one of the following (randomly generated):

    Given a person->id:
        type: URL, data: image_url
        type: BIRTH, data: birthday + birthplace
        type: QUOTE, data: quote
        type: NAME, data: name initials with strikeouts
*        type: CHARACTER, data: character name

    Given a movie->id:
        type: URL, data: image_url
        type: RELEASE, data: release date
        type: QUOTE, data: slogan
        type: NAME, data: name initials with strikeouts

 */


class fdvegan_rest_api_GameData
{
