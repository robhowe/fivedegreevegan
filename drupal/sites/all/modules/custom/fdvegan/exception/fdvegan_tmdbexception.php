...
class FDVegan_TmdbException extends FDVegan_Exception  //, TMDbException
{

    public function __construct($message = null, $code = 0, Exception $previous = null, $priority = 'LOG_NOTICE')
    {
