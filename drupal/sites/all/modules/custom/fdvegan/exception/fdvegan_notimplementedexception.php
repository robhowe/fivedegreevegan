<?php
/**
 * fdvegan_notimplementedexception.php
 *
...
class FDVegan_NotImplementedException extends FDVegan_Exception  //, BadMethodCallException
{

    public function __construct($message = null, $code = 0, Exception $previous = null, $priority = 'LOG_CRIT')
    {
