 ...
 * API methods specs: https://developers.themoviedb.org/3/getting-started
...
class TMDb
{
	 ...
	 * More information about the authentication process: https://developers.themoviedb.org/3/authentication/create-request-token
	 *
	 * @return TMDb result array
	 */
	 ...
	 * More information about the authentication process: https://developers.themoviedb.org/3/authentication/create-session
	 *
	 * @param string $token
	 * @return TMDb result array
	 */
	 ...
	 * @return TMDb result array
	 */
// FDVEGAN DEBUG:  updated the following line:  (needed to make this method non-private so we can override it in fdvegan_tmdb.php
//	private function _makeCall($function, $params = NULL, $session_id = NULL, $method = TMDb::GET)
 ...
 fdvegan_Content::syslog('LOG_ERR', "Overridden parent function called! _makeCall('{$function}','{$method}') params: " . print_r($params,1));
 exit(-1);
